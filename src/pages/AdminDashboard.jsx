                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-xl">
                      <div className="flex items-center">
                        ...
                        <span className="text-slate-700 font-medium">Product Listings</span>
                      </div>
                      <div className="flex items-center">
                    ...
                    <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-xl">
                      <div className="flex items-center">
                        ...
                        <span className="text-slate-700 font-medium">User Registration</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-2 h-2 bg-emerald-500 rounded-full mr-2"></div>
                        <span className="text-sm text-emerald-700 font-medium">Active</span>
                    ...
                    <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-xl">
                      <div className="flex items-center">
                        ...
                        <span className="text-slate-700 font-medium">Image Upload</span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-2 h-2 bg-emerald-500 rounded-full mr-2"></div>
                        <span className="text-sm text-emerald-700 font-medium">Active</span>
                ...
                <div className="p-6">
                  {activitiesLoading && recentActivities.length === 0 ? (
                    ...
                    <div className="text-center text-slate-500 py-12">
                      ...
                      <p className="text-lg font-medium text-slate-600 mb-2">No recent activity</p>
                      <p className="text-sm text-slate-500">Activities will appear here as they happen</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      {recentActivities.map((activity) => {
                        ...
                        return (
                          ...
                          >
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${getActivityColorClass(activity.color)}`}>
