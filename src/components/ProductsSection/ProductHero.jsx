...
const ProductHero = () => {
  ...
  return (
    <div className="relative w-full">
      <div style={{ background: "linear-gradient(to top, #fcf5ea 0%, rgba(255, 255, 255, 0) 20%)", }} className="absolute inset-0 z-52"></div>
      {/* Mobile Layout */}
        ...
        <div className="pt-30">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-900 text-[12px] max-w-[45ch] font-light tracking-tighte text-base sm:text-lg mb-8 mx-auto">
              Unique, personalized gifts crafted with love and attention to detail. 
          ...
          <div className="relative h-80 w-full flex items-center justify-center overflow-hidden">
            {polaroids.map((polaroid) => (
              <div
                key={polaroid.id}
                className={`absolute ${polaroid.centerPosition} ${polaroid.zIndex} transform ${polaroid.rotation} transition-all duration-700 ease-out cursor-pointer ${
      ...
      <div className="hidden lg:block">
        <div style={{ background: "linear-gradient(to top, #fcf5ea 0%, rgba(255, 255, 255, 0) 50%)", }} className="absolute inset-0 z-52"></div>
